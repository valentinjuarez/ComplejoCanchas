...
export default function AdminChangePasswordPage() {
  ...
  function validate() {
    ...
    if (currentPassword.trim().length < 6)
      return 'La contraseña actual debe tener al menos 6 caracteres';

    if (!newPassword.trim()) return 'Ingresá tu nueva contraseña';
      ...
      <div className="relative mx-auto max-w-xl">
        ...
        <div className="overflow-hidden rounded-3xl bg-white shadow-xl">
          <div className="bg-gradient-to-r from-purple-600 to-blue-600 p-6 text-white">
            ...
            <p className="text-purple-100">Actualizá tu contraseña de admin</p>
          </div>
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <p className="mt-2 text-xs text-gray-500">
                  Recomendación: usá una contraseña distinta a la de otros sitios.
                </p>
              </div>
        ...
        <div className="mt-6 rounded-2xl bg-white/70 p-4 text-sm text-gray-600 shadow-sm backdrop-blur">
          Nota: si en algún momento querés invalidar tokens viejos al cambiar
          contraseña, ahí sí conviene hacer que el backend rote el token o use
          una “tokenVersion”.
        </div>
      </div>
    </main>
