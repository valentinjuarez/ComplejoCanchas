...
export default function BookingSuccess({ reservation }: Props) {
    ...
    <div className="overflow-hidden rounded-3xl bg-white shadow-xl">
      ...
      <div className="p-8">
        ...
        <button
          ...
          className="mt-6 w-full rounded-xl border-2 border-purple-600 px-6 py-3 font-semibold text-purple-600 transition hover:bg-purple-50"
        >
          Hacer otra reserva
        </button>
      </div>
